...
exports.sendReplyEmail = exports.sendEmail = exports.adminInquiries = exports.api = void 0;
...
// Zoho SMTP 설정
const ZOHO_USER = ((_a = functions.config().zoho) === null || _a === void 0 ? void 0 : _a.user) || process.env.ZOHO_USER || 'admin@cloudsitefy.com';
const ZOHO_PASS = ((_b = functions.config().zoho) === null || _b === void 0 ? void 0 : _b.pass) || process.env.ZOHO_PASS || 'your-zoho-password';
// Zoho SMTP 트랜스포터 생성
...
const sendEmailToAdmin = async (data) => {
    ...
    const adminEmail = {
        ...
        to: ((_a = functions.config().email) === null || _a === void 0 ? void 0 : _a.admin) || process.env.ADMIN_EMAIL || 'admin@cloudsitefy.com',
...
const saveInquiryToFirestore = async (data) => {
    const inquiryData = Object.assign(Object.assign({}, data), { createdAt: admin.firestore.FieldValue.serverTimestamp(), status: 'new', read: false, responded: false });
...
exports.adminInquiries = functions.https.onRequest(async (req, res) => {
    res.set('Access-Control-Allow-Origin', '*');
    ...
    try {
        ...
        if (req.method === 'GET') {
            ...
            const inquiries = snapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
...
// 답변 이메일 전송 함수
exports.sendReplyEmail = functions.https.onRequest(async (req, res) => {
    res.set('Access-Control-Allow-Origin', '*');
