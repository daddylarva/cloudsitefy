      ...
      <div className="max-w-7xl mx-auto container-padding relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6 animate-fade-in-up animation-delay-400 group">
              ...
              <h3 className="text-xl font-bold text-secondary-900 mb-3 group-hover:text-primary-600 transition-colors duration-300">Professional Design</h3>
              <p className="text-secondary-600 leading-relaxed">Custom website design that matches your brand</p>
            </div>
            
            <div className="p-6 animate-fade-in-up animation-delay-500 group">
              ...
              <h3 className="text-xl font-bold text-secondary-900 mb-3 group-hover:text-accent-600 transition-colors duration-300">Fast Performance</h3>
              <p className="text-secondary-600 leading-relaxed">Optimized performance for fast loading speeds</p>
            </div>
            
            <div className="p-6 animate-fade-in-up animation-delay-600 group">
              <div className="w-20 h-20 bg-gradient-to-br from-success-100 to-success-200 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-soft">
                <svg className="w-10 h-10 text-success-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-secondary-900 mb-3 group-hover:text-success-600 transition-colors duration-300">Continuous Management</h3>
              <p className="text-secondary-600 leading-relaxed">Regular updates and maintenance</p>
            </div>
          </div>
        </div>
      </div>
